    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <div class="project-info-box">
                <p><b>Tanggal Laporan:</b> {{$laporan->tgl_laporan}}</p>
                <p><b>Lokasi Kejadian:</b> {{$laporan->lokasi_kejadian}}</p>
                <p><b>Relawan:</b> {{$laporan->relawan->nama}}</p>
                <p><b>Jenis Bencana:</b> {{$laporan->jenisBencana->nama_bencana}}</p>
            </div><!-- / project-info-box -->
        ...
        <div class="col-md-7">
            ...
            @else
            <img src="{{url('admin/images')}}/{{$laporan->foto}}" alt="project-image" class="rounded">
            @endempty
        </div>
    </div>
</div>
