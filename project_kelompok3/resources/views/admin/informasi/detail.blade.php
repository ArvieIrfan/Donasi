...
<div class="container"> 
    <div class="m-b-5">
        <div class="table-data__tool">
            <a href="{{route('informasi.index')}}" class="btn au-btn-icon btn-secondary au-btn--small">
    ...
    <div class="row">
        <div class="col-md-5">
            <div class="project-info-box mt-0">
                <h4>DETAIL INFORMASI BENCANA</h4><br>
                <p>{{$informasiBencana->judul}}</p>
            </div><!-- / project-info-box -->

            <div class="project-info-box">
                <p><b>Tanggal Bencana:</b> {{$informasiBencana->tgl_bencana}}</p>
                <p><b>Lokasi Kejadian:</b> {{$informasiBencana->laporan->lokasi_kejadian}}</p>
                <p><b>Relawan:</b> {{$informasiBencana->laporan->relawan->nama}}</p>
                <p><b>Jenis Bencana:</b> {{$informasiBencana->laporan->jenisBencana->nama_bencana}}</p>
                <p><b>Tingkat Keparahan:</b> {{$informasiBencana->tingkat_keparahan}}</p>
                <p><b>Target Donasi:</b> Rp{{ number_format($informasiBencana->target_donasi, 0, ',', '.') }}</p>
            </div><!-- / project-info-box -->

            <div class="project-info-box mt-0 mb-0">
                <h5>Keterangan:</h5><br>
                <p class="mb-0">{{$informasiBencana->keterangan}}</p>
            </div><!-- / project-info-box -->
        </div><!-- / column -->

        <div class="col-md-7">
            @empty($informasiBencana->laporan->foto)
            <img src="{{url('admin/images/nophoto.jpg')}}" alt="project-image" class="rounded">
            @else
            <img src="{{url('admin/images')}}/{{$informasiBencana->laporan->foto}}" alt="project-image" class="rounded">
            @endempty
        </div>
    </div>
</div>
